...
\resizebox{!}{0.1\textheight}{
  \begin{tikzpicture} [scale=1, auto,>=latex]
    ...
    \node[vertex, label=below:{$\Leaf_{11}$},label={[xshift=0.0cm, yshift=-1.5cm]\small$\{4\}$}](d11) at (2.0, -4) {\usebox{\genericfilt}};
    \node[vertex, label=below:{$\Leaf_{12}$},label={[xshift=0.0cm, yshift=-1.5cm]\small$\{1\}$}](d12) at (2.75, -4) {\usebox{\genericfilt}};
    \node[vertex, label=below:{$\Leaf_{13}$},label={[xshift=0.0cm, yshift=-1.5cm]\small$\{2\}$}](d13) at (3.5, -4) {\usebox{\genericfilt}};
    \node[vertex, label=below:{$\Leaf_{14}$},label={[xshift=0.0cm, yshift=-1.5cm]\small$\{3\}$}](d14) at (4.25, -4) {\usebox{\genericfilt}};
    ...
    \node[vertex, label=right:{$\SumNode_4$}, label=left:{\small$p(X_1,X_4) = $}](s4) at (1.75, -2) {\large$\bm+$};
    \node[vertex, label=right:{$\SumNode_5$}, label=left:{\small$p(X_2,X_3)=$}](s5) at (4.75, -2) {\large$\bm+$};
    
    % second layer
    \node[vertex, label=right:{$\ProductNode_1$}, label=left:{$p(X_1,\dots,X_4) = $}](j1) at (-2.725, -1) {\large$\bm\times$};
    \node[vertex, label=right:{$\ProductNode_2$}, label=left:{$p(X_1,X_4)p(X_2,X_3) = $}](j2) at (3.25, -1) {\large$\bm\times$};
    
    % Root
    \node[vertex, label=right:{$\SumNode_1$}, label=left:{$p(X_1,X_2,X_3,X_4) = $}](s1) at (0, 0.5) {\large$\bm+$};
