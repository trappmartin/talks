...
\begin{frame}{Bayesian Structure \& Parameter Learning}
    \begin{itemize}
        \item This approach obtains competitive results.
        \item It can be used in heterogeneous data domains and can be extended to nonparametric formulations.
        \item And this approach can be used in cases of missing values, using exact marginalisation.
    \end{itemize}
