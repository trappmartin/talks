...
\addplot [color=black, dashed, mark=square*, mark options={solid},visible on=<3->] coordinates {
    (20, -52.9306308300396)%
...
\addplot [color=violet, dotted, mark=*, mark options={solid},visible on=<2->] coordinates {
...
\addplot [color=violet, dotted, mark=square*, mark options={solid},visible on=<4->] coordinates {
...
\addplot [color=blue, solid, mark=*, mark options={solid}, visible on=<5->] coordinates {
    (20, -51.784)%
    (40, -51.997)%
    (60, -52.415)%
    (80, -52.85)%
