...
\DeclareMathOperator*{\f}{\SPN(\xn \,|\, \theta)}
\DeclareMathOperator*{\fz}{\SPN(\bm \ast \,|\, \theta)}
\DeclareMathOperator*{\fy}{\SPN(\xn, \lambda_n \,|\, \theta)}
\DeclareMathOperator*{\fzy}{\SPN(\bm \ast, \lambda_n \,|\, \theta)}
